...
const Home = () => {
  const assetsToPreload = [
    '@/vids/Banner.mp4',
    'https://firebasestorage.googleapis.com/v0/b/elamana-6d79e.appspot.com/o/playreel.mp4?alt=media&token=36879b7d-a837-4089-8bdf-5e7f5dd85ad5',
  ...
  const assetsLoaded = usePreloadAssets(assetsToPreload);
