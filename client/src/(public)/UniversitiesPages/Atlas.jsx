...
import bg1 from '../../components/imgs/at2.jpg'
import bg2 from '../../components/imgs/at3.jpg'
import bg3 from '../../components/imgs/at4.jpg'
import bg4 from '../../components/imgs/at1.webp'
export default function AtlasUni() {
    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{t('atlasunititlep')}</h1>
          </div>
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            <div>
              ...
              <div className="space-y-6">
                <p className="text-base text-gray-900">{t('atlasuniarticlepara1')}</p>
              </div>
            </div>

            <div className="mt-10">
              <h3 className="text-sm font-medium text-gray-900">{t('atlasuniarticleadvantagestitle')}</h3>
