...
import bg1 from '../../components/imgs/istinyeuni-campus.png'
import bg2 from '../../components/imgs/istinyeunipic.jpg'
import bg3 from '../../components/imgs/istmedipolcover.jpg'
import bg4 from '../../components/imgs/istinyeunipic.jpg'
export default function IstinyeUni() {
    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{t('istinyeunititlep')}</h1>
          </div>
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            <div>
              ...
              <div className="space-y-6">
                <p className="text-base text-gray-900">{t('istinyeuniarticlepara1')}</p>
              </div>
            </div>
            ...
            <div className='my-8'>
<a
                href="https://firebasestorage.googleapis.com/v0/b/amana1912system.appspot.com/o/istinye.pdf?alt=media&token=f8dfbd10-03ed-4217-bb52-6fe523f3e8f2&_gl=1*p7tk1e*_ga*MzcwNTQ3MTQyLjE2OTY3MzE3OTA.*_ga_CW55HF8NVT*MTY5NzE3MzA2OC4xMy4xLjE2OTcxNzQ0OTguNjAuMC4w"
                target="_blank"
