...
import bg1 from '../../components/imgs/fenerbahce-uni.jpg'
import bg2 from '../../components/imgs/fenerbahceunilogo.png'
import bg4 from '../../components/imgs/fenerbahce-uni.jpg'
import bg3 from '../../components/imgs/fenerbahceunilogo.png'
export default function FenerbahceUni() {
    ...
    <div className="bg-white">
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-gray-900 sm:text-3xl">{t('fenerbahceunititlep')}</h1>
          </div>
          ...
          <div className="py-10 lg:col-span-2 lg:col-start-1 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
            <div>
              ...
              <div className="space-y-6">
                <p className="text-base text-gray-900">{t('fenerbahceuuniarticlepara1')}</p>
              </div>
            </div>

            <div className="mt-10">
              <h3 className="text-sm font-medium text-gray-900">{t('fenerbahceuniarticleadvantagestitle')}</h3>
