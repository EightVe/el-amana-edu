...
const IstiniyeUniMain = () => {
  const assetsToPreload = [
    '../components/imgs/istinyeuni-campus.png',
    '../components/imgs/istinyeunipic.jpg',
    "../components/imgs/istmedipolcover.jpg",
  ];
...
export default IstiniyeUniMain;
