...
const BeykentUniMain = () => {
  const assetsToPreload = [
    '../components/imgs/beykent1.jpg',
    '../components/imgs/beykent2.jpg',
    "../components/imgs/beykent3.jpg",
    "../components/imgs/SCSC.jpg",
  ];
